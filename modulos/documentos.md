...
Cada **participante confirmado** — pague ele a inscrição ou não — tem um **comprovante individual de inscrição** próprio, com uma página no celular e uma versão em **PDF** para baixar ou imprimir: nome, modalidade, código, evento, data, local e situação.
