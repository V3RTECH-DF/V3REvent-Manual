...
- **Total de inscrições** — número de pedidos (cada pedido pode ter vários inscritos).
...
- **Inscritos por mês** — o ritmo de adesão.
- **Receita por mês** — o resultado financeiro no tempo.

## Listas recentes

Abaixo, você vê as **inscrições recentes** e os **últimos eventos**, com atalhos para abrir cada um.
